...
class MockLlm(BaseLlm):
    ...
    def _decide(self, req: LlmRequest) -> LlmResponse:
        ...
        if _wants_json(req):
            ...
            # graph_builder stage 1: surface entities from this turn's text. Reads
            # the raw last user message — `[source]` tags would trip _is_synthetic.
            ...
            # entity a NEW node. That all-new wrong-split is the floor, on purpose:
            # it shows why real resolution needs a real backend.
