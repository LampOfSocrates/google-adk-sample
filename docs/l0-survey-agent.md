...
> (`tests/graph_builder/fixtures/sample_repo1/`, with `expected/survey_snapshot.json`) and the Online
> Boutique vendor script (`scripts/graph_builder/vendor_demo_system.ps1`) are ready, but no survey
